...
| `$83:C7F8` | `Lufia2ActorPrimaryUpdate` | `draft` | Portable front-end reconstructs the gates/timer path and `$83:C83C..C866` VM dispatch. Native handler semantics now include `$83:C8C7`, `$83:CC85/$83:CCA3` coordinate range branches, `$83:D14D` through its conditional `$83:D350` child-call boundary (the D350 core itself is now separately reconstructed through `$83:D389`), `$83:D2B4/$83:D2BD` script-cursor jumps/alias tail, and `$83:D2C4/$83:D2D5` actor-mask updates. Full handler coverage remains incomplete. |
| `$83:D350` | `Lufia2ActorPrimaryActionCore` | `draft` | Common primary-VM action/movement helper. Local paths, all four `$83:D3B7/$83:D3C5/$83:D3D7/$83:D3E5` boundary helpers and the `$83:D3F7` secondary-script installer are reconstructed. The collision/movement path currently stops immediately before `JSL $83:FB12` at `$83:D389`. |
