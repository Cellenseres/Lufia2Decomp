...
| `$83:C7F8` | `Lufia2ActorPrimaryUpdate` | `draft` | Portable front-end reconstructs the gates/timer path and `$83:C83C..C866` VM dispatch. Native handler semantics now include the direct D350 action cluster at `$83:C867/$83:C86B/$83:C86F/$83:C873/$83:C877/$83:C87C/$83:C880/$83:C884/$83:C888`, `$83:C8C7`, `$83:C891` (via D3F7), `$83:C8EE`, `$83:C8FC/$83:C90A`, `$83:CBB7` (via F9D4), `$83:CBE1`, `$83:CC1B/$83:CC2E`, `$83:CC41/$83:CC63` (via D350), `$83:CC85/$83:CCA3`, full `$83:D14D -> D350 -> C8C7`, `$83:D2B4/$83:D2BD`, and `$83:D2C4/$83:D2D5`. Absolute-indexed reads carry into the next bank, matching the CPU. Full handler coverage remains incomplete. |
